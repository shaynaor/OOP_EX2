...
import Geom.Point3D;
/**
 * This class converts a Decimal degrees latitude longitude altitude point, into a ECEF(earth-centered, earth-fixed) 
 * x,y,z point and the other way around.
...
public class ConvertGpsToXyz {
	...
	public static final double f = 1 / 298.257223563; // WGS84 flattening wiki link: https://en.wikipedia.org/wiki/Flattening
	...
	/**
	 * converting a ECEF x,y,z point in meters to lla (latitude longitude altitude)point.
	 * The formula taken from : https://stackoverflow.com/questions/18253546/ecef-to-lla-lat-lon-alt-in-java.
	...
	/**
	 * Converts a lla point into a ECEF x,y,z point.
	 * The formula taken from : http://mathforum.org/library/drmath/view/51832.html.
