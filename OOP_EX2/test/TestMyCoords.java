...
class TestMyCoords {
	 ...
	 * distance that the point moved in that direction compared to what it was told to move.
	 * we check 1000 points and move them between 0 to 2000km
	 * accuracy offset allowed for x is 0.001%
	 * accuracy offset allowed for y is 0.001%
	 */
